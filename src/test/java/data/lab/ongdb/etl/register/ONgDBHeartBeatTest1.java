...
public class ONgDBHeartBeatTest1 {
    ...
    // DEV
    private static Login login = ServerConfiguration.getDev();
...
//    private static Login login = ServerConfiguration.getDev();
    ...
    public static void main(String[] args) {
        ...
        OngdbHeartBeat heartBeat = new OngdbHeartBeat(login.getInitHost(), login.getUserName(), login.getPassword(), ServerConfiguration.httpDetectionInterval());
