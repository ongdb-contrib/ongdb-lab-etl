...
public class NeoIndexer extends NeoAccessor implements Indexer {
     ...
     */
    @Override
    public void addNodeFullTextSearch(String fullTextSearchName, FullTextMap.FullTextNodeMap fullTextMap, boolean autoUpdate) {
     ...
     */
    @Override
    public void addNodeFullTextSearchAutoUpdate(String fullTextSearchName, FullTextMap.FullTextNodeMap fullTextMap) {
